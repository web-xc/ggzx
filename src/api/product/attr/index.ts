...
enum API {
    ...
    DELETEATTR_API = '/admin/product/deleteAttr/'         // 删除分类下的属性
}
...
// 获取三级分类接口的方法
export const reqC3 = (category2id: number | string) => request.get<any, CategoryResponseData>(API.C3_API + category2id)
...
// 删除分类下某个属性接口的方法
export const reqRemoveAttr = (attrId: number) => request.delete<any, any>(API.DELETEATTR_API + attrId)